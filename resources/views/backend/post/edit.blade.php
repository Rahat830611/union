                ...
                <div class="row">
                 ...
                 <div class="row">
                  ...
                  <div class="form-check col-md-6">
                    ...
                    <label class="form-check-label" for="exampleCheck1">ভিডিও নিউজ</label>
                  </div>
                   ...
                   <div class="form-check col-md-6">
                    ...
                    <label class="form-check-label" for="exampleCheck1">সর্বশেষ সংবাদ</label>
                  </div>
                  ...
                  <div class="form-check col-md-6">
                    ...
                    <label class="form-check-label" for="exampleCheck1">হোম পেইজে দেখান</label>
                  </div>
				                    <div class="form-check col-md-6">
                    <input type="checkbox" class="form-check-input" id="exampleCheck1" name="categoryhomepage" value="1"   <?php  if ($post->first_section_thumbnail == 1) {
                    	 echo "checked";
                    } ?> >
                    <label class="form-check-label" for="exampleCheck1">হোম পেইজে ক্যাটাগরি অপশনে নিউজ দেখান</label>
                  </div>
