...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0 text-dark">Staff ADD</h1>
      </div><!-- /.col -->
      <div class="col-sm-6">
                      ...
                      <div class="modal-body">
                         <form action="{{ route('store.writer') }}" method="Post">
                           ...
                           <div class="form-group">
                             ...
                             <input type="text" class="form-control "  aria-describedby="emailHelp" name="facebookid" required="">
                           </div>
                           ...
                           <div class="row">
                                ...
                                <div class="form-group col-lg-3">
								 ...
								 <div class="form-group col-lg-3">
		                             ...
		                             <input type="checkbox" class="form-control "  aria-describedby="emailHelp" name="allpost" value="1">
                                </div>
                                <div class="form-group col-lg-3">
