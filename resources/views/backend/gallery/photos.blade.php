              ...
              <table id="example1" class="table table-bordered table-striped">
               ...
               @foreach($photo as $row)
                <tr>
                  ...
                  <td>
                  	@if($row->type == 1)
                  	      <span class="badge badge-success">sangskritik</span>
						  @else
                  	      <span class="badge badge-info">mujib</span>
                  	      @endif
                  </td>
                  <td>
                  	  <a href="{{ route('delete.photogallery',$row->id) }}" class="btn btn-danger" id="delete"> <i class="fa fa-trash"></i> </a>
                  </td>
                </tr>
            	@endforeach
                </tbody>
            ...
            <div class="modal-body">
               <form action="{{ route('store.photos') }}" method="Post" enctype="multipart/form-data">
                 ...
                 <select class="form-control" name="type" required>
                 	  <option value="1">Sangskritik</option>
                 	  <option value="0">Mujib</option>
                 </select>
