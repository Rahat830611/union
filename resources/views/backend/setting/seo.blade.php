                         ...
                         <form action="{{ route('update.seo',$seo->id) }}" method="Post">
                           ...
                           <div class="form-group">
                             ...
                             <input type="text" class="form-control " value="{{ $seo->meta_description }}" aria-describedby="emailHelp" name="meta_description" required="">
						                              ...
						                              <div class="form-group">
                             <label for="exampleInputEmail1">Prodhan Nirbahi Name</label>
                             <input type="text" class="form-control " value="{{ $seo->upodkahhoname }}" aria-describedby="emailHelp" name="upodkahhoname" required="">
                           </div>
						                              <div class="form-group">
                             <label for="exampleInputEmail1">Prodhan Nirbahi Short Details</label>
                            ...
                            <div class="form-group">
                             <label for="exampleInputEmail1">Prodhan Nirbahi Long Details</label>
                          ...
                          style="width: 100%; height: 300px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
                            ...
                            <div class="form-group">
                             <label for="exampleInputEmail1">Meyor  Details</label>
                          ...
                          style="width: 100%; height: 300px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
                             ...
                             <input type="text" class="form-control " value="{{ $seo->googlemaplink }}" aria-describedby="emailHelp" name="googlemaplink" required="">
                           </div>
