...
//important website
    ...
    public function UpdateWebsite(Request $request,$id)
    {
           ...
           if ($image) {
                ...
                Image::make($image)->resize(1200,154)->save('public/ads/'.$image_one);    //   public/postimages/123123.jpg
           ...
           if ($image) {
                $image_one= uniqid().'.'.$image->getClientOriginalExtension();    //123123.jpg
                Image::make($image)->resize(600,337)->save('public/ads/'.$image_one);    //   public/postimages/123123.jpg
